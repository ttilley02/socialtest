BEGIN;
  ...
  VALUES
    ...
    (
      'All the other reviewers are obviously insane, but this post is actually pretty amazing.',
      5,
      1,
      4
  ),
    (
      'When life gives you lemons, trade them for this post.',
      4,
      1,
      5
  ),
    ...
    (
      'There are some better posts. There are also some worse posts.',
      3,
      7,
      1
  ),
    ...
    (
      'It does not say this on the label, but this post can be used to summon rain on the spring equinox with the proper incantation.',
      3,
      7,
      3
  ),
